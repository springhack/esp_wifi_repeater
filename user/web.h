...
<head></head>\
<body>\
<h1>Alxw WiFi NAT Router Config</h1>\
<div id='config'>\
<script>\
if (window.location.search.substr(1) != '')\
{\
document.getElementById('config').display = 'none';\
document.body.innerHTML ='<h1>Alxw WiFi NAT Router Config</h1>The new settings have been sent to the device...';\
...
{\
document.getElementById('config').display = 'none';\
document.body.innerHTML ='<h1>Alxw WiFi NAT Router Config</h1>Unlock request has been sent to the device...';\
